...
cases_replace_placeholder = [
    ('placeholder.testchamber_text', {'text': 'pass'}),
    ('placeholder.testchamber_capital', {'text': 'pass'}),
    ('placeholder.testchamber_underscore', {'underscored_text': 'pass'}),
    ('placeholder.testchamber_number', {'test4science': 'pass'}),
    ('placeholder.testchamber_edgecase', {'complicated__placeholder': 'pass'})
]

cases_handle_invalid_placeholder = [
    ('placeholder.testchamber_text', {'nonexistence': 'failed'}),
    ('placeholder.testchamber_text', {'Text': 'failed'}),
